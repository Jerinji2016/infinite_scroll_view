...
class ExamplePageView extends StatefulWidget {
  const ExamplePageView({Key? key}) : super(key: key);

  @override
  State<ExamplePageView> createState() => _ExamplePageViewState();
}

class _ExamplePageViewState extends State<ExamplePageView> {
